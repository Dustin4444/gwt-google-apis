...
export function ResetPasswordForm() {
  ...
  const strengthColors = ["bg-destructive", "bg-destructive/60", "bg-accent", "bg-accent/70", "bg-emerald-500"]
          ...
          {!isSuccess ? (
            <div className="space-y-6">
              ...
              <div className="lg:hidden flex items-center justify-center mb-8">
                ...
                <h1 className="text-2xl font-bold text-foreground">CMS Full Form</h1>
              </div>
                ...
                <div className="bg-secondary rounded-lg p-4">
                  ...
                  <ul className="text-sm text-muted-foreground space-y-1">
                    <li className="flex items-center space-x-2">
                      <div
                        className={`w-2 h-2 rounded-full ${formData.password.length >= 8 ? "bg-emerald-500" : "bg-muted"}`}
                      />
                      <span>At least 8 characters</span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <div
                        className={`w-2 h-2 rounded-full ${/[A-Z]/.test(formData.password) ? "bg-emerald-500" : "bg-muted"}`}
                      />
                    ...
                    <li className="flex items-center space-x-2">
                      <div
                        className={`w-2 h-2 rounded-full ${/[0-9]/.test(formData.password) ? "bg-emerald-500" : "bg-muted"}`}
                      />
